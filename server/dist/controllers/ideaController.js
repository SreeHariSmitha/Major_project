 ...
 */
export const generatePhase2 = async (req, res, next) => {
    try {
        const { id } = req.params;
        const idea = await Idea.findOne({
            _id: id,
        ...
        await Version.createVersion(idea._id, {
            ...
            phase1Data: idea.phase1Data,
            phase2Data: idea.phase2Data,
        }, 'phase2_generated', 'Phase 2 business model analysis generated');
        res.status(200).json({
            success: true,
            data: {
                id: idea._id,
 ...
 */
export const confirmPhase2 = async (req, res, next) => {
    try {
        const { id } = req.params;
        const idea = await Idea.findOne({
            _id: id,
        ...
        await Version.createVersion(idea._id, {
            ...
            phase1Data: idea.phase1Data,
            phase2Data: idea.phase2Data,
        }, 'phase2_confirmed', 'Phase 2 confirmed');
        res.status(200).json({
            success: true,
            data: {
                id: idea._id,
 ...
 */
export const generatePhase3 = async (req, res, next) => {
    try {
        const { id } = req.params;
        ...
        const phase3Data = generatePhase3Content(idea.title, idea.description, idea.phase1Data, idea.phase2Data);
        // Update idea
        idea.phase = 'Phase 3';
        ...
        await Version.createVersion(idea._id, {
            ...
            phase2Data: idea.phase2Data,
            phase3Data: idea.phase3Data,
        }, 'phase3_generated', 'Generated Phase 3 pitch deck content');
        res.status(200).json({
            success: true,
            data: {
                id: idea._id,
 ...
 */
export const confirmPhase3 = async (req, res, next) => {
    try {
        const { id } = req.params;
        const userId = req.userId;
        const idea = await Idea.findOne({ _id: id, userId });
        ...
        await Version.createVersion(idea._id, {
            ...
            phase2Data: idea.phase2Data,
            phase3Data: idea.phase3Data,
        }, 'phase3_confirmed', 'Confirmed Phase 3 - Pitch deck complete');
        res.status(200).json({
            success: true,
            data: {
                id: idea._id,
 ...
 */
function generatePhase3Content(title, description, phase1Data, phase2Data) {
 ...
 */
function generatePhase2Content(title, description, phase1Data) {
    const descLower = description.toLowerCase();
    const isB2B = descLower.includes('b2b') || descLower.includes('business') || descLower.includes('enterprise');
